...
import * as i3$1 from '@polpware/ngx-pipes';
import { PolpwareNgxPipesModule } from '@polpware/ngx-pipes';
import * as i1$3 from 'ngx-bootstrap/modal';
import { ModalModule } from 'ngx-bootstrap/modal';
import * as i2$2 from 'ngx-file-drop';
import { NgxFileDropModule } from 'ngx-file-drop';
import * as i2$3 from '@polpware/modal-directives';
...
class DataPreviewComponent extends NgxDatatablePoweredBase {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DataPreviewComponent, selectors: [["polp-data-preview"]], viewQuery: function DataPreviewComponent_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuery(_c0$3, 7)(_c1$2, 7);
        } if (rf & 2) {
            let _t;
...
function DataProcessorComponent_Conditional_2_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    const _r2 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 22);
    i0.ɵɵlistener("click", function DataProcessorComponent_Conditional_2_Conditional_2_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r2); const ctx_r2 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r2.startAdd()); });
    i0.ɵɵelement(1, "fa-icon", 21);
    i0.ɵɵtext(2, " Add ");
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r2 = i0.ɵɵnextContext(2);
    i0.ɵɵproperty("disabled", ctx_r2.selected.length > 0 || ctx_r2.anyEditing);
    i0.ɵɵadvance();
    i0.ɵɵproperty("icon", ctx_r2.faPlus);
} }
function DataProcessorComponent_Conditional_2_Conditional_3_Template(rf, ctx) { if (rf & 1) {
    const _r4 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 23);
    i0.ɵɵlistener("click", function DataProcessorComponent_Conditional_2_Conditional_3_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r4); const ctx_r2 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r2.rmAsync()); });
    i0.ɵɵelement(1, "fa-icon", 21);
    i0.ɵɵtext(2, " Delete ");
    i0.ɵɵelementEnd();
} if (rf & 2) {
    ...
    i0.ɵɵadvance();
    i0.ɵɵproperty("icon", ctx_r2.faTrash);
} }
function DataProcessorComponent_Conditional_2_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    const _r5 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 24);
    i0.ɵɵtext(1, " This operation will discard all changes and cannot be undo. Are you sure to continue? ");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(2, "div")(3, "button", 25);
    i0.ɵɵlistener("click", function DataProcessorComponent_Conditional_2_ng_template_8_Template_button_click_3_listener() { i0.ɵɵrestoreView(_r5); const ctx_r2 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r2.isConfirmReset = false); });
    i0.ɵɵelement(4, "fa-icon", 21);
    i0.ɵɵtext(5, " Cancel ");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(6, "button", 26);
    i0.ɵɵlistener("click", function DataProcessorComponent_Conditional_2_ng_template_8_Template_button_click_6_listener() { i0.ɵɵrestoreView(_r5); const ctx_r2 = i0.ɵɵnextContext(2); ctx_r2.isConfirmReset = false; return i0.ɵɵresetView(ctx_r2.reset()); });
    ...
    i0.ɵɵadvance(3);
    i0.ɵɵproperty("icon", ctx_r2.faExclamationTriangle);
} }
function DataProcessorComponent_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 9)(1, "div", 16);
    i0.ɵɵconditionalCreate(2, DataProcessorComponent_Conditional_2_Conditional_2_Template, 3, 2, "button", 17);
    i0.ɵɵconditionalCreate(3, DataProcessorComponent_Conditional_2_Conditional_3_Template, 3, 2, "button", 18);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(4, "div", 19)(5, "button", 20);
    i0.ɵɵlistener("click", function DataProcessorComponent_Conditional_2_Template_button_click_5_listener() { i0.ɵɵrestoreView(_r1); const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.isConfirmReset = true); });
    i0.ɵɵelement(6, "fa-icon", 21);
    i0.ɵɵtext(7, " Reset ");
    i0.ɵɵelementEnd()();
    i0.ɵɵtemplate(8, DataProcessorComponent_Conditional_2_ng_template_8_Template, 9, 2, "ng-template", null, 6, i0.ɵɵtemplateRefExtractor);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const confirmResetTmpl_r6 = i0.ɵɵreference(9);
    const ctx_r2 = i0.ɵɵnextContext();
    i0.ɵɵadvance(2);
    i0.ɵɵconditional(ctx_r2.settings.canCreate ? 2 : -1);
    i0.ɵɵadvance();
    i0.ɵɵconditional(ctx_r2.settings.canDelete ? 3 : -1);
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("popover", confirmResetTmpl_r6)("isOpen", ctx_r2.isConfirmReset)("disabled", ctx_r2.selected.length > 0 || ctx_r2.anyEditing);
    i0.ɵɵadvance();
    i0.ɵɵproperty("icon", ctx_r2.faUndo);
} }
function DataProcessorComponent_ng_template_12_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "div", 27);
} if (rf & 2) {
    const column_r7 = ctx.column;
    i0.ɵɵproperty("innerHTML", column_r7.name, i0.ɵɵsanitizeHtml);
} }
function DataProcessorComponent_ng_template_14_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "span", 28);
} if (rf & 2) {
    const value_r8 = i0.ɵɵnextContext().value;
    i0.ɵɵproperty("innerHTML", value_r8, i0.ɵɵsanitizeHtml);
} }
function DataProcessorComponent_ng_template_14_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    const _r9 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "input", 30);
    i0.ɵɵlistener("blur", function DataProcessorComponent_ng_template_14_Conditional_1_Template_input_blur_0_listener($event) { i0.ɵɵrestoreView(_r9); const ctx_r9 = i0.ɵɵnextContext(); const rowIndex_r11 = ctx_r9.rowIndex; const column_r12 = ctx_r9.column; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.updateValue($event, column_r12.prop, rowIndex_r11)); });
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r9 = i0.ɵɵnextContext();
    const column_r12 = ctx_r9.column;
    const value_r8 = ctx_r9.value;
    i0.ɵɵproperty("type", column_r12.inputType)("value", value_r8);
} }
function DataProcessorComponent_ng_template_14_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵconditionalCreate(0, DataProcessorComponent_ng_template_14_Conditional_0_Template, 1, 1, "span", 28);
    i0.ɵɵconditionalCreate(1, DataProcessorComponent_ng_template_14_Conditional_1_Template, 1, 2, "input", 29);
} if (rf & 2) {
    const rowIndex_r11 = ctx.rowIndex;
    const column_r12 = ctx.column;
    const ctx_r2 = i0.ɵɵnextContext();
    i0.ɵɵconditional(!ctx_r2.editing[rowIndex_r11 + "-" + column_r12.prop] ? 0 : -1);
    i0.ɵɵadvance();
    i0.ɵɵconditional(ctx_r2.editing[rowIndex_r11 + "-" + column_r12.prop] ? 1 : -1);
} }
...
function DataProcessorComponent_ng_template_18_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    const _r13 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 32);
    i0.ɵɵlistener("click", function DataProcessorComponent_ng_template_18_Conditional_0_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r13); const rowIndex_r14 = i0.ɵɵnextContext().rowIndex; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.startEdit(rowIndex_r14)); });
    i0.ɵɵelement(1, "fa-icon", 33);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r2 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance();
    i0.ɵɵproperty("icon", ctx_r2.faEdit);
} }
function DataProcessorComponent_ng_template_18_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    const _r15 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 32);
    i0.ɵɵlistener("click", function DataProcessorComponent_ng_template_18_Conditional_1_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r15); const rowIndex_r14 = i0.ɵɵnextContext().rowIndex; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.confirmEditAsync(rowIndex_r14)); });
    i0.ɵɵelement(1, "fa-icon", 33);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(2, "button", 34);
    i0.ɵɵlistener("click", function DataProcessorComponent_ng_template_18_Conditional_1_Template_button_click_2_listener() { i0.ɵɵrestoreView(_r15); const rowIndex_r14 = i0.ɵɵnextContext().rowIndex; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.cancelEdit(rowIndex_r14)); });
    i0.ɵɵelement(3, "fa-icon", 33);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r2 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance();
    i0.ɵɵproperty("icon", ctx_r2.faCheck);
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("icon", ctx_r2.faTimes);
} }
function DataProcessorComponent_ng_template_18_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵconditionalCreate(0, DataProcessorComponent_ng_template_18_Conditional_0_Template, 2, 1, "button", 31)(1, DataProcessorComponent_ng_template_18_Conditional_1_Template, 4, 2);
} if (rf & 2) {
    const rowIndex_r14 = ctx.rowIndex;
    const ctx_r2 = i0.ɵɵnextContext();
    i0.ɵɵconditional(!ctx_r2.backup[rowIndex_r14] ? 0 : 1);
} }
let DataProcessorComponent = class DataProcessorComponent extends NgxDatatableLocalData {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DataProcessorComponent, selectors: [["polp-data-processor"]], viewQuery: function DataProcessorComponent_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuery(_c0$2, 7)(_c1$1, 7)(_c2$1, 7)(_c3$1, 7)(_c4$1, 7);
        } if (rf & 2) {
            let _t;
        ...
        } }, inputs: { initData: "initData", columnNames: "columnNames" }, outputs: { dataChange: "dataChange", onReset: "onReset" }, standalone: false, features: [i0.ɵɵInheritDefinitionFeature, i0.ɵɵNgOnChangesFeature], decls: 20, vars: 16, consts: [["searchBox", ""], ["datatable", ""], ["titleHeader", ""], ["inputCell", ""], ["editActionHeader", ""], ["editActionCell", ""], ["confirmResetTmpl", ""], [1, "card"], [1, "card-body"], ["role", "toolbar", "aria-label", "Operations", 1, "btn-toolbar", "mb-4"], [3, "isCollapsed"], ["title", ""], ["body", "", 1, "container"], ["theme", "dark", "title", "Logs", 3, "logStream", "animated", "icons"], ["formClass", "border rounded my-2 py-4 px-4 bg-light", 3, "onSearch", "debounceTime", "minLength"], ["headerHeight", "auto", "rowHeight", "auto", 1, "bootstrap", 3, "select", "rows", "columns", "columnMode", "footerHeight", "limit", "scrollbarH", "selected", "selectionType", "selectAllRowsOnPage"], ["role", "group", "aria-label", "Update", 1, "btn-group", "me-2"], ["role", "button", 1, "btn", "btn-success", 3, "disabled"], ["role", "button", 1, "btn", "btn-danger", 3, "disabled"], ["role", "group", "aria-label", "Reset", 1, "btn-group", "me-2"], ["role", "button", "triggers", "", "container", "body", "popoverTitle", "Warning", 1, "btn", "btn-warning", 3, "click", "popover", "isOpen", "disabled"], [1, "me-1", 3, "icon"], ["role", "button", 1, "btn", "btn-success", 3, "click", "disabled"], ["role", "button", 1, "btn", "btn-danger", 3, "click", "disabled"], [1, "alert", "alert-warning"], ["role", "button", 1, "btn", "btn-info", "me-2", 3, "click"], ["role", "button", 1, "btn", "btn-warning", 3, "click"], [1, "fw-bold", "text-wrap", 3, "innerHTML"], [3, "innerHTML"], ["autofocus", "", 3, "type", "value"], ["autofocus", "", 3, "blur", "type", "value"], ["role", "button", 1, "btn", "btn-outline-primary", "icon-only"], ["role", "button", 1, "btn", "btn-outline-primary", "icon-only", 3, "click"], [3, "icon"], ["role", "button", 1, "btn", "btn-outline-warning", "icon-only", 3, "click"]], template: function DataProcessorComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "div", 7)(1, "div", 8);
            i0.ɵɵconditionalCreate(2, DataProcessorComponent_Conditional_2_Template, 10, 6, "div", 9);
            i0.ɵɵelementStart(3, "polp-bs-expandable-card", 10)(4, "span", 11);
            i0.ɵɵtext(5, " Operation logs ");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(6, "div", 12);
            i0.ɵɵelement(7, "log-monitor", 13);
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(8, "polp-bs-search-box-widget", 14, 0);
            ...
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(10, "ngx-datatable", 15, 1);
        ...
        } }, dependencies: [i2.PopoverDirective, i3.ExpandableCardComponent, i3.SearchBoxWidgetComponent, i4.FaIconComponent, i1.DatatableComponent, i6.LogMonitorComponent], encapsulation: 2 }); }
};
...
function DataPublicationComponent_ng_template_24_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "span", 21);
} if (rf & 2) {
    const value_r2 = i0.ɵɵnextContext().value;
    i0.ɵɵproperty("innerHTML", value_r2, i0.ɵɵsanitizeHtml);
} }
function DataPublicationComponent_ng_template_24_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    const _r3 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "input", 23);
    i0.ɵɵlistener("blur", function DataPublicationComponent_ng_template_24_Conditional_1_Template_input_blur_0_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r3 = i0.ɵɵnextContext(); const rowIndex_r5 = ctx_r3.rowIndex; const column_r6 = ctx_r3.column; const ctx_r6 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r6.updateValue($event, column_r6.prop, rowIndex_r5)); });
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r3 = i0.ɵɵnextContext();
    const column_r6 = ctx_r3.column;
    const value_r2 = ctx_r3.value;
    i0.ɵɵproperty("type", column_r6.inputType)("value", value_r2);
} }
function DataPublicationComponent_ng_template_24_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵconditionalCreate(0, DataPublicationComponent_ng_template_24_Conditional_0_Template, 1, 1, "span", 21);
    i0.ɵɵconditionalCreate(1, DataPublicationComponent_ng_template_24_Conditional_1_Template, 1, 2, "input", 22);
} if (rf & 2) {
    const rowIndex_r5 = ctx.rowIndex;
    const column_r6 = ctx.column;
    const ctx_r6 = i0.ɵɵnextContext();
    i0.ɵɵconditional(!ctx_r6.editing[rowIndex_r5 + "-" + column_r6.prop] ? 0 : -1);
    i0.ɵɵadvance();
    i0.ɵɵconditional(ctx_r6.editing[rowIndex_r5 + "-" + column_r6.prop] ? 1 : -1);
} }
...
function DataPublicationComponent_ng_template_28_Case_0_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span", 25);
    i0.ɵɵelement(1, "fa-icon", 28);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r6 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance();
    i0.ɵɵproperty("icon", ctx_r6.faHourglass);
} }
function DataPublicationComponent_ng_template_28_Case_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span", 25);
    i0.ɵɵelement(1, "fa-icon", 29);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r6 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance();
...
function DataPublicationComponent_ng_template_28_Case_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r6 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance();
    i0.ɵɵproperty("icon", ctx_r6.faCheck);
} }
function DataPublicationComponent_ng_template_28_Case_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r6 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance();
    i0.ɵɵproperty("icon", ctx_r6.faTimes);
} }
function DataPublicationComponent_ng_template_28_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵconditionalCreate(0, DataPublicationComponent_ng_template_28_Case_0_Template, 2, 1, "span", 25)(1, DataPublicationComponent_ng_template_28_Case_1_Template, 2, 1, "span", 25)(2, DataPublicationComponent_ng_template_28_Case_2_Template, 2, 1, "span", 26)(3, DataPublicationComponent_ng_template_28_Case_3_Template, 2, 1, "span", 27);
} if (rf & 2) {
    let tmp_8_0;
    const value_r8 = ctx.value;
    i0.ɵɵconditional((tmp_8_0 = value_r8) === "waiting" ? 0 : tmp_8_0 === "working" ? 1 : tmp_8_0 === "success" ? 2 : tmp_8_0 === "failure" ? 3 : -1);
} }
let DataPublicationComponent = class DataPublicationComponent extends NgxDatatableLocalData {
    ...
    async uploadAllAsync() {
        ...
        for (let pIndex = 0; (noError && pIndex < totalPages); pIndex++) {
            ...
            this.datatable.offset.set(pIndex);
            // One page 
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DataPublicationComponent, selectors: [["polp-data-publication"]], viewQuery: function DataPublicationComponent_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuery(_c0$1, 7)(_c1, 7)(_c2, 7)(_c3, 7)(_c4, 7)(_c5, 7);
        } if (rf & 2) {
            let _t;
            i0.ɵɵqueryRefresh(_t = i0.ɵɵloadQuery()) && (ctx.searchBox = _t.first);
            i0.ɵɵqueryRefresh(_t = i0.ɵɵloadQuery()) && (ctx.datatable = _t.first);
        ...
        } }, dependencies: [i3.ExpandableCardComponent, i3.SearchBoxWidgetComponent, i4.FaIconComponent, i1.DatatableComponent, i6.LogMonitorComponent], encapsulation: 2 }); }
};
...
function DefineColumnMappingComponent_For_15_For_13_Template(rf, ctx) { if (rf & 1) {
...
function DefineColumnMappingComponent_For_15_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementStart(8, "div", 3)(9, "select", 8)(10, "option", 9);
    i0.ɵɵtext(11, "...");
    i0.ɵɵelementEnd();
    i0.ɵɵrepeaterCreate(12, DefineColumnMappingComponent_For_15_For_13_Template, 3, 5, "option", 10, i0.ɵɵrepeaterTrackByIdentity);
    i0.ɵɵelementEnd()();
    ...
    const ctx_r2 = i0.ɵɵnextContext();
    i0.ɵɵadvance();
    i0.ɵɵproperty("formGroupName", ɵ$index_25_r2);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1(" ", ɵ$index_25_r2 + 1, " ");
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("innerHtml", i0.ɵɵpipeBind2(6, 3, ctx_r2.sourceLabel(ɵ$index_25_r2), "html"), i0.ɵɵsanitizeHtml);
    i0.ɵɵadvance(7);
    i0.ɵɵrepeater(ctx_r2.targetColumns);
} }
...
class DefineColumnMappingComponent extends DefaultFormBaseComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DefineColumnMappingComponent, selectors: [["polp-define-column-mapping"]], inputs: { sourceColumns: "sourceColumns", targetColumns: "targetColumns", initValue: "initValue" }, standalone: false, features: [i0.ɵɵInheritDefinitionFeature], decls: 16, vars: 1, consts: [[3, "formGroup"], [1, "form-row", "mb-4"], [1, "col-1"], [1, "col-4"], [1, "col-3"], ["formArrayName", "mappings"], [3, "formGroupName"], [3, "innerHtml"], ["formControlName", "targetId", 1, "form-control", "form-control-sm"], ["value", ""], [3, "value"]], template: function DefineColumnMappingComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵrepeaterCreate(14, DefineColumnMappingComponent_For_15_Template, 14, 6, "div", 1, i0.ɵɵrepeaterTrackByIdentity);
            i0.ɵɵelementContainerEnd();
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            i0.ɵɵproperty("formGroup", ctx.form);
            i0.ɵɵadvance(14);
            i0.ɵɵrepeater(ctx.mappings.controls);
        } }, dependencies: [i1$2.ɵNgNoValidate, i1$2.NgSelectOption, i1$2.ɵNgSelectMultipleOption, i1$2.SelectControlValueAccessor, i1$2.NgControlStatus, i1$2.NgControlStatusGroup, i1$2.FormGroupDirective, i1$2.FormControlName, i1$2.FormGroupName, i1$2.FormArrayName, i3$1.SafeDomPipe], encapsulation: 2 }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DefineColumnMappingComponent, [{
        type: Component,
        args: [{ selector: 'polp-define-column-mapping', standalone: false, template: "<form  [formGroup]=\"form\">\n  <!-- Header -->\n  <div class=\"form-row mb-4\">\n    <div class=\"col-1\">\n      #\n    </div>\n    <div class=\"col-4\">\n      <b>Source</b>\n    </div>\n    <div class=\"col-3\">\n      <b>Example</b>\n    </div>\n    <div class=\"col-4\">\n      <b>Target</b>\n    </div>\n  </div>\n\n  <ng-container formArrayName=\"mappings\">\n    @for (f of mappings.controls; track f; let i = $index) {\n      <div class=\"form-row mb-4\">\n        <ng-container [formGroupName]=\"i\">\n          <div class=\"col-1\">\n            {{i + 1}}\n          </div>\n          <div class=\"col-4\">\n            <div [innerHtml]=\"sourceLabel(i) | safeDom:'html'\"></div>\n          </div>\n          <div class=\"col-3\">\n            <!-- Something -->\n          </div>\n          <div class=\"col-4\">\n            <select class=\"form-control form-control-sm\" formControlName=\"targetId\">\n              <option value=\"\">...</option>\n              @for (o of targetColumns; track o) {\n                <option [value]=\"o.id\">\n                  <span [innerHtml]=\"o.label | safeDom:'html'\">\n                  </span>\n                </option>\n              }\n            </select>\n          </div>\n        </ng-container>\n      </div>\n    }\n  </ng-container>\n\n</form>\n" }]
...
function DropFileModalComponent_For_9_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 7)(1, "span");
    i0.ɵɵtext(2);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(3, "button", 12);
    i0.ɵɵlistener("click", function DropFileModalComponent_For_9_Template_button_click_3_listener() { const f_r2 = i0.ɵɵrestoreView(_r1).$implicit; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.onRemove(f_r2)); });
    i0.ɵɵtext(4, "Remove");
    i0.ɵɵelementEnd()();
} if (rf & 2) {
...
class DropFileModalComponent extends ObservableModalAbstractComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DropFileModalComponent, selectors: [["polp-drop-file-modal"]], inputs: { multiple: "multiple", accept: "accept", maxFileSizeInBytes: "maxFileSizeInBytes" }, standalone: false, features: [i0.ɵɵInheritDefinitionFeature], decls: 17, vars: 5, consts: [["polpModalDraggable", "", 1, "modal-header"], [1, "modal-title"], ["type", "button", "aria-label", "Close", 1, "btn-close", 3, "click"], [1, "modal-body"], [3, "onFileDrop", "multiple", "accept"], ["ngx-file-drop-content-tmp", ""], [1, "file-previews"], [1, "preview-item"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], [1, "btn", "btn-primary", 3, "click", "disabled"], [1, "me-1", 3, "icon"], [3, "click"]], template: function DropFileModalComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵrepeaterCreate(8, DropFileModalComponent_For_9_Template, 5, 2, "div", 7, i0.ɵɵrepeaterTrackByIdentity);
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(10, "div", 8)(11, "button", 9);
            i0.ɵɵlistener("click", function DropFileModalComponent_Template_button_click_11_listener() { return ctx.close(); });
            i0.ɵɵtext(12, "Cancel");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(13, "button", 10);
            i0.ɵɵlistener("click", function DropFileModalComponent_Template_button_click_13_listener() { return ctx.confirm(); });
            i0.ɵɵelement(14, "fa-icon", 11);
        ...
        } }, dependencies: [i2$2.NgxFileDropComponent, i2$2.NgxFileDropContentTemplateDirective, i2$3.polpModalDraggableDirective, i4.FaIconComponent], encapsulation: 2 }); }
}
...
function ExportDataWizardComponent_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 0)(1, "div", 5)(2, "span", 6);
    i0.ɵɵtext(3);
    i0.ɵɵelementEnd();
    i0.ɵɵtext(4, " Please review the following snippet of the data to be exported, and then continue to the next step. ");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(5, "div", 7);
    i0.ɵɵelement(6, "polp-data-preview", 8);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
...
function ExportDataWizardComponent_Conditional_1_Conditional_6_Template(rf, ctx) { if (rf & 1) {
    const _r2 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div")(1, "button", 10);
    i0.ɵɵlistener("click", function ExportDataWizardComponent_Conditional_1_Conditional_6_Template_button_click_1_listener() { i0.ɵɵrestoreView(_r2); const ctx_r0 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r0.confirmExport()); });
    i0.ɵɵtext(2, " Start to export ");
    i0.ɵɵelementEnd()();
} }
function ExportDataWizardComponent_Conditional_1_Conditional_7_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "log-monitor", 9);
} if (rf & 2) {
    const ctx_r0 = i0.ɵɵnextContext(2);
    i0.ɵɵproperty("logStream", ctx_r0.logStream)("animated", true)("icons", true);
} }
function ExportDataWizardComponent_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 0)(1, "div", 5)(2, "span", 6);
    i0.ɵɵtext(3);
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(5, "div", 7);
    i0.ɵɵconditionalCreate(6, ExportDataWizardComponent_Conditional_1_Conditional_6_Template, 3, 0, "div")(7, ExportDataWizardComponent_Conditional_1_Conditional_7_Template, 1, 3, "log-monitor", 9);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate1("Step ", ctx_r0.stepIndex + 1);
    i0.ɵɵadvance(3);
    i0.ɵɵconditional(!ctx_r0.confirmed ? 6 : 7);
} }
function ExportDataWizardComponent_Conditional_3_Template(rf, ctx) { if (rf & 1) {
    const _r3 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 11);
    i0.ɵɵlistener("click", function ExportDataWizardComponent_Conditional_3_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r3); const ctx_r0 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r0.prevStep()); });
...
function ExportDataWizardComponent_Conditional_5_Template(rf, ctx) { if (rf & 1) {
    const _r4 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 13);
    i0.ɵɵlistener("click", function ExportDataWizardComponent_Conditional_5_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r4); const ctx_r0 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r0.nextStep()); });
    i0.ɵɵtext(1, " Next ");
...
class ExportDataWizardComponent extends WizardAbstractComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ExportDataWizardComponent, selectors: [["polp-export-data-wizard"]], inputs: { columns: "columns", downloadAsync: "downloadAsync" }, standalone: false, features: [i0.ɵɵInheritDefinitionFeature], decls: 6, vars: 4, consts: [[1, "card"], [1, "d-flex", "mt-4", "mb-4"], ["type", "button", 1, "btn", "btn-warning", 3, "disabled"], [1, "me-auto"], ["type", "button", 1, "btn", "btn-primary", 3, "disabled"], [1, "card-header", "h6"], [1, "badge", "rounded-pill", "bg-dark", "me-1"], [1, "card-body"], [3, "initData", "columnNames"], ["theme", "dark", "title", "Data export logs", 3, "logStream", "animated", "icons"], ["type", "button", 1, "btn", "btn-primary", "btn-lg", "btn-block", 3, "click"], ["type", "button", 1, "btn", "btn-warning", 3, "click", "disabled"], [3, "icon"], ["type", "button", 1, "btn", "btn-primary", 3, "click", "disabled"]], template: function ExportDataWizardComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵconditionalCreate(0, ExportDataWizardComponent_Conditional_0_Template, 7, 3, "div", 0);
            i0.ɵɵconditionalCreate(1, ExportDataWizardComponent_Conditional_1_Template, 8, 2, "div", 0);
            i0.ɵɵelementStart(2, "div", 1);
            i0.ɵɵconditionalCreate(3, ExportDataWizardComponent_Conditional_3_Template, 3, 2, "button", 2);
            i0.ɵɵelement(4, "span", 3);
            i0.ɵɵconditionalCreate(5, ExportDataWizardComponent_Conditional_5_Template, 3, 2, "button", 4);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            i0.ɵɵconditional(ctx.visible(0) ? 0 : -1);
            i0.ɵɵadvance();
            i0.ɵɵconditional(ctx.visible(1) ? 1 : -1);
            i0.ɵɵadvance(2);
            i0.ɵɵconditional(ctx.hasPrevStep ? 3 : -1);
            i0.ɵɵadvance(2);
            i0.ɵɵconditional(ctx.hasNextStep ? 5 : -1);
        } }, dependencies: [i4.FaIconComponent, i6.LogMonitorComponent, DataPreviewComponent], encapsulation: 2 }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ExportDataWizardComponent, [{
        type: Component,
        args: [{ selector: 'polp-export-data-wizard', standalone: false, template: "@if (visible(0)) {\n  <div class=\"card\">\n    <div class=\"card-header h6\">\n      <span class=\"badge rounded-pill bg-dark me-1\">Step {{stepIndex + 1}}</span>\n      Please review the following snippet of the data to be\n      exported, and then continue to the next step.\n    </div>\n    <div class=\"card-body\">\n      <polp-data-preview [initData]=\"state.preview.rows\"\n        [columnNames]=\"state.preview.cols\">\n      </polp-data-preview>\n    </div>\n  </div>\n}\n\n@if (visible(1)) {\n  <div class=\"card\">\n    <div class=\"card-header h6\">\n      <span class=\"badge rounded-pill bg-dark me-1\">Step {{stepIndex + 1}}</span>\n      Please confirm ...\n    </div>\n    <div class=\"card-body\">\n      @if (!confirmed) {\n        <div>\n          <button type=\"button\" class=\"btn btn-primary btn-lg btn-block\" (click)=\"confirmExport()\">\n            Start to export\n          </button>\n        </div>\n      } @else {\n        <log-monitor\n          [logStream]=\"logStream\"\n          theme=\"dark\"\n          title=\"Data export logs\"\n          [animated]=\"true\"\n          [icons]=\"true\">\n        </log-monitor>\n      }\n    </div>\n  </div>\n}\n\n<!-- Navigation -->\n<div class=\"d-flex mt-4 mb-4\">\n  @if (hasPrevStep) {\n    <button type=\"button\" class=\"btn btn-warning\" [disabled]=\"disablePrevStep\"\n      (click)=\"prevStep()\">\n      <fa-icon [icon]=\"faArrowLeft\"></fa-icon>\n      Previous\n    </button>\n  }\n  <span class=\"me-auto\"></span>\n  @if (hasNextStep) {\n    <button type=\"button\" class=\"btn btn-primary\" [disabled]=\"disableNextStep\"\n      (click)=\"nextStep()\">\n      Next\n      <fa-icon [icon]=\"faArrowRight\"></fa-icon>\n    </button>\n  }\n</div>\n\n" }]
    }], () => [], { columns: [{
            type: Input
        }], downloadAsync: [{
            type: Input
...
class ExportWizardModalComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ExportWizardModalComponent, selectors: [["polp-export-wizard-modal"]], inputs: { columns: "columns", downloadAsync: "downloadAsync" }, standalone: false, decls: 6, vars: 3, consts: [["polpModalDraggable", "", 1, "modal-header"], [1, "modal-title"], ["type", "button", "aria-label", "Close", 1, "btn-close", 3, "click"], [1, "modal-body"], [3, "columns", "downloadAsync"]], template: function ExportWizardModalComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [i2$3.polpModalDraggableDirective, ExportDataWizardComponent], encapsulation: 2 }); }
}
...
function ImportDataWizardComponent_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 0)(1, "div", 5)(2, "span", 6);
    i0.ɵɵtext(3);
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(5, "div", 7)(6, "polp-data-processor", 8);
    i0.ɵɵlistener("onReset", function ImportDataWizardComponent_Conditional_0_Template_polp_data_processor_onReset_6_listener() { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.resetPreprocessor()); })("dataChange", function ImportDataWizardComponent_Conditional_0_Template_polp_data_processor_dataChange_6_listener($event) { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.updatePreprocessor($event)); });
    i0.ɵɵelementEnd()()();
} if (rf & 2) {
...
function ImportDataWizardComponent_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    const _r3 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 0)(1, "div", 5)(2, "span", 6);
    i0.ɵɵtext(3);
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(5, "div", 7)(6, "polp-define-column-mapping", 9);
    i0.ɵɵlistener("onValueChanged", function ImportDataWizardComponent_Conditional_1_Template_polp_define_column_mapping_onValueChanged_6_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.updateMappings($event)); })("onValidation", function ImportDataWizardComponent_Conditional_1_Template_polp_define_column_mapping_onValidation_6_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.validateMappings($event)); });
    i0.ɵɵelementEnd()()();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance(3);
...
function ImportDataWizardComponent_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    const _r4 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 0)(1, "div", 5)(2, "span", 6);
    i0.ɵɵtext(3);
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(5, "div", 7)(6, "polp-data-processor", 8);
    i0.ɵɵlistener("onReset", function ImportDataWizardComponent_Conditional_2_Template_polp_data_processor_onReset_6_listener() { i0.ɵɵrestoreView(_r4); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.resetPostprocessor()); })("dataChange", function ImportDataWizardComponent_Conditional_2_Template_polp_data_processor_dataChange_6_listener($event) { i0.ɵɵrestoreView(_r4); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.updatePostprocessor($event)); });
    i0.ɵɵelementEnd()()();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance(3);
...
function ImportDataWizardComponent_Conditional_3_Template(rf, ctx) { if (rf & 1) {
    const _r5 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 0)(1, "div", 5)(2, "span", 6);
    i0.ɵɵtext(3);
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(5, "div", 7)(6, "polp-data-publication", 10);
    i0.ɵɵlistener("onImport", function ImportDataWizardComponent_Conditional_3_Template_polp_data_publication_onImport_6_listener() { i0.ɵɵrestoreView(_r5); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.startImport()); })("afterImport", function ImportDataWizardComponent_Conditional_3_Template_polp_data_publication_afterImport_6_listener($event) { i0.ɵɵrestoreView(_r5); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.updateImportStat($event)); });
    i0.ɵɵelementEnd()()();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance(3);
...
function ImportDataWizardComponent_Conditional_5_Template(rf, ctx) { if (rf & 1) {
    const _r6 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 11);
    i0.ɵɵlistener("click", function ImportDataWizardComponent_Conditional_5_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r6); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.prevStep()); });
    i0.ɵɵelement(1, "fa-icon", 12);
    i0.ɵɵtext(2, " Previous ");
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function ImportDataWizardComponent_Conditional_7_Template(rf, ctx) { if (rf & 1) {
    const _r7 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 13);
    i0.ɵɵlistener("click", function ImportDataWizardComponent_Conditional_7_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r7); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.nextStep()); });
    i0.ɵɵtext(1, " Next ");
    i0.ɵɵelement(2, "fa-icon", 12);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
class ImportDataWizardComponent extends WizardAbstractComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ImportDataWizardComponent, selectors: [["polp-import-data-wizard"]], inputs: { file: "file", targetColumns: "targetColumns", uploadAsync: "uploadAsync" }, standalone: false, features: [i0.ɵɵInheritDefinitionFeature], decls: 8, vars: 6, consts: [[1, "card"], [1, "d-flex", "mt-4", "mb-4"], ["type", "button", 1, "btn", "btn-warning", 3, "disabled"], [1, "me-auto"], ["type", "button", 1, "btn", "btn-primary", 3, "disabled"], [1, "card-header", "h6"], [1, "badge", "rounded-pill", "bg-dark", "me-1"], [1, "card-body"], [3, "onReset", "dataChange", "initData", "columnNames"], [3, "onValueChanged", "onValidation", "sourceColumns", "targetColumns", "initValue"], [3, "onImport", "afterImport", "columnNames", "uploadAsync", "initData"], ["type", "button", 1, "btn", "btn-warning", 3, "click", "disabled"], [3, "icon"], ["type", "button", 1, "btn", "btn-primary", 3, "click", "disabled"]], template: function ImportDataWizardComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵconditionalCreate(0, ImportDataWizardComponent_Conditional_0_Template, 7, 3, "div", 0);
            i0.ɵɵconditionalCreate(1, ImportDataWizardComponent_Conditional_1_Template, 7, 4, "div", 0);
            i0.ɵɵconditionalCreate(2, ImportDataWizardComponent_Conditional_2_Template, 7, 3, "div", 0);
            i0.ɵɵconditionalCreate(3, ImportDataWizardComponent_Conditional_3_Template, 7, 4, "div", 0);
            i0.ɵɵelementStart(4, "div", 1);
            i0.ɵɵconditionalCreate(5, ImportDataWizardComponent_Conditional_5_Template, 3, 2, "button", 2);
            i0.ɵɵelement(6, "span", 3);
            i0.ɵɵconditionalCreate(7, ImportDataWizardComponent_Conditional_7_Template, 3, 2, "button", 4);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            i0.ɵɵconditional(ctx.visible(0) ? 0 : -1);
            i0.ɵɵadvance();
...
class ImportWizardModalComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ImportWizardModalComponent, selectors: [["polp-import-wizard-modal"]], viewQuery: function ImportWizardModalComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [i2$3.polpModalDraggableDirective, ImportDataWizardComponent], encapsulation: 2 }); }
}
