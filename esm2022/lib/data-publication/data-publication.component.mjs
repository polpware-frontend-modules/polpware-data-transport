...
let DataPublicationComponent = class DataPublicationComponent extends NgxDatatableLocalData {
    ...
    static { this.ɵfac = function DataPublicationComponent_Factory(t) { return new (t || DataPublicationComponent)(i0.ɵɵdirectiveInject(i1.NgxNotyImpl)); }; }
