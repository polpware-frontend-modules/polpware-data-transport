...
let DataProcessorComponent = class DataProcessorComponent extends NgxDatatableLocalData {
    ...
    static { this.ɵfac = function DataProcessorComponent_Factory(t) { return new (t || DataProcessorComponent)(i0.ɵɵdirectiveInject(i1.NgxNotyImpl)); }; }
