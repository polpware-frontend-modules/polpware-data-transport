...
export declare class DataProcessorComponent extends NgxDatatableLocalData<IRowDataType> implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DataProcessorComponent, "polp-data-processor", never, { "initData": "initData"; "columnNames": "columnNames"; }, { "dataChange": "dataChange"; "onReset": "onReset"; }, never, never, false, never>;
}
