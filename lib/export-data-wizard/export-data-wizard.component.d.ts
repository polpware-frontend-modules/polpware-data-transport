...
export declare class ExportDataWizardComponent extends WizardAbstractComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ExportDataWizardComponent, "polp-export-data-wizard", never, { "columns": "columns"; "downloadAsync": "downloadAsync"; }, {}, never, never, false, never>;
}
export {};
