...
import * as i1 from "./drop-file-modal/drop-file-modal.component";
import * as i2 from "./import-data-wizard/import-data-wizard.component";
import * as i3 from "./import-wizard-modal/import-wizard-modal.component";
import * as i4 from "./define-column-mapping/define-column-mapping.component";
import * as i5 from "./data-staging/data-staging.component";
import * as i6 from "./data-publication/data-publication.component";
import * as i7 from "./data-processor/data-processor.component";
import * as i8 from "./export-data-wizard/export-data-wizard.component";
import * as i9 from "./export-wizard-modal/export-wizard-modal.component";
import * as i10 from "./data-preview/data-preview.component";
