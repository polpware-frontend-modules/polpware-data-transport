...
export declare class DataPublicationComponent extends NgxDatatableLocalData<IPubRowType> implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DataPublicationComponent, "polp-data-publication", never, { "initData": "initData"; "columnNames": "columnNames"; "uploadAsync": "uploadAsync"; }, { "onImport": "onImport"; "afterImport": "afterImport"; }, never, never, false>;
}
export {};
